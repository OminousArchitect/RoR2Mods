...
namespace VayneMod.SkillStates
{
    public class Tumble : BaseSkillState
    {
        ...
        {
            this.rollSpeed = this.moveSpeedStat * Mathf.Lerp(Tumble.initialSpeedCoefficient, Tumble.finalSpeedCoefficient, base.fixedAge / Tumble.duration);
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.cameraTargetParams) base.cameraTargetParams.fovOverride = Mathf.Lerp(Tumble.dodgeFOV, 60f, base.fixedAge / Tumble.duration);
